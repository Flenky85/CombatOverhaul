...
{
    [AutoRegister]
    internal static class CureCriticalWoundsMassDamageAbilityTweaks
    {
        public static void Register()
        {
            AbilityConfigurator.For(AbilitiesGuids.CureCriticalWoundsMassDamage)
                ...
                .SetDescriptionValue(
                    "You channel positive energy to cure 1d3 points of damage per caster level (maximum 18d3) on " +
