...
{
    [AutoRegister]
    internal static class FalseLifeAbilityTweaks
    {
        public static void Register()
        {
            AbilityConfigurator.For(AbilitiesGuids.FalseLife)
                ...
                .SetDescriptionValue(
                    ...
                    "you gain temporary hit points equal to 1d6 per 2 caster levels(maximum 3d6)."
                )
                .Configure();
        }
    }
