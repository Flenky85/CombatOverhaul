...
{
    [AutoRegister]
    internal static class CureLightWoundsDamageAbilityTweaks
    {
        public static void Register()
        {
            AbilityConfigurator.For(AbilitiesGuids.CureLightWoundsDamage)
                ...
                .SetDescriptionValue(
                    ...
                    "(maximum 4d4). Since undead are powered by negative energy, this spell deals damage to them instead of curing their wounds. " +
