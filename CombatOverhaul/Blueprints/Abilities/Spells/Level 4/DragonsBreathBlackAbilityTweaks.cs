...
{
    [AutoRegister]
    internal static class DragonsBreathBlackAbilityTweaks
    {
        public static void Register()
        {
            AbilityConfigurator.For(AbilitiesGuids.DragonsBreathBlack)
                ...
                .SetDescriptionValue(
                    "You breathe out a blast of acid in the form of a 60-foot line. Creatures in the affected " +
