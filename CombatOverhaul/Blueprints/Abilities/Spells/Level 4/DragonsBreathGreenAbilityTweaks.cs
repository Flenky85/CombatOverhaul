...
{
    [AutoRegister]
    internal static class DragonsBreathGreenAbilityTweaks
    {
        public static void Register()
        {
            AbilityConfigurator.For(AbilitiesGuids.DragonsBreathGreen)
                ...
                .SetDescriptionValue(
                    "You breathe out a stream of acid in the form of a 30-foot cone. Creatures in the affected " +
