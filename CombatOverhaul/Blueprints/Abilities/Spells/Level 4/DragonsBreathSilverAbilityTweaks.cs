...
{
    [AutoRegister]
    internal static class DragonsBreathSilverAbilityTweaks
    {
        public static void Register()
        {
            AbilityConfigurator.For(AbilitiesGuids.DragonsBreathSilver)
                ...
                .SetDescriptionValue(
                    "You breathe out a blast of cold in the form of a 30-foot cone. Creatures in the affected " +
