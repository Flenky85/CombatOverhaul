...
{
    [AutoRegister]
    internal static class InflictLightWoundsMassDamageAbilityTweaks
    {
        public static void Register()
        {
            AbilityConfigurator.For(AbilitiesGuids.InflictLightWoundsMassDamage)
                ...
                .SetDescriptionValue(
                    ...
                    "points of damage per caster level (maximum 12d3) to nearby living enemies.\n" +
