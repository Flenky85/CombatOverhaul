...
{
    [AutoRegister]
    internal static class CureLightWoundsMassDamageAbilityTweaks
    {
        public static void Register()
        {
            AbilityConfigurator.For(AbilitiesGuids.CureLightWoundsMassDamage)
                ...
                .SetDescriptionValue(
                    "You channel positive energy to cure 1d3 points of damage per caster level (maximum 12d3) on " +
