...
{
    [AutoRegister]
    internal static class CallLightningStormAbilityTweaks
    {
        public static void Register()
        {
            AbilityConfigurator.For(AbilitiesGuids.CallLightningStorm)
                ...
                .SetDescriptionValue(
                    ...
                    "30-foot-long, vertical bolt of lightning that deals 5d6 points of electricity damage. The bolt of lightning " +
