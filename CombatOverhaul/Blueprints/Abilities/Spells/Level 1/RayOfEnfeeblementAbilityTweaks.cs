        ...
        public static void Register()
        {
            AbilityConfigurator.For(AbilitiesGuids.RayOfEnfeeblement)
                ...
                .SetDescriptionValue(
                    ...
                    "A successful Fortitude save halves this damage. The subject also takes a penalty to Strength equal to 1d6 " +
                    "plus 1 per two caster levels, maximum 1d6+5. The subject’s Strength score cannot drop below 1. A successful " +
                    "Fortitude save reduces this penalty by half. This penalty does not stack with itself; apply the highest " +
                    "penalty instead. The Strength penalty lasts for 2d3 rounds."
                )
                .Configure();
        }
    }
