...
{
    [AutoRegister]
    internal static class CureCriticalWoundsDamageAbilityTweaks
    {
        public static void Register()
        {
            AbilityConfigurator.For(AbilitiesGuids.CureCriticalWoundsDamage)
                ...
                .SetDescriptionValue(
                    ...
                    "(maximum 10d4). Since undead are powered by negative energy, this spell deals damage to them instead of curing their wounds. " +
