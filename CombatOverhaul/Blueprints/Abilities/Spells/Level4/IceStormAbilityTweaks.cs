...
{
    [AutoRegister]
    internal static class IceStormAbilityTweaks
    {
        public static void Register()
        {
            AbilityConfigurator.For(AbilitiesGuids.IceStorm)
                ...
                .SetDescriptionValue(
                    "Great magical hailstones pound down when this spell is cast, dealing 1d4 cold damage per caster level (maximum 10d4) to every creature in the area. " +
                    "This damage occurs once on cast. For the remaining 2d3 rounds, heavy snow and sleet rain down in the area. " +
                    "Creatures inside this area take a -4 penalty on Perception skill checks, and the entire area is treated as difficult terrain. " +
                    "When the duration ends, the snow and hail disappear, leaving no aftereffects other than the damage dealt."
                )
                .Configure();
        }
    }
