...
{
    [AutoRegister]
    internal static class FesterMassAbilityTweaks
    {
        public static void Register()
        {
            AbilityConfigurator.For(AbilitiesGuids.FesterMass)
                ...
                .EditComponent<AbilityEffectRunAction>(c =>
                {
                    ...
                    save.Actions.Actions = new GameAction[] { dmg, saved };
                })
                .SetDuration2d3RoundsShared()
                .SetDescriptionValue(
                    "Necrotic energy permeates targets in the area, blocking healing abilities. The subject gains spell resistance equal to (12 + your caster level) " +
                    "against effects that restore hit points or grant temporary hit points. If the target succeeds on a " +
                    "Fortitude saving throw, fester lasts only a single round. The spell also deals 1d3 " +
                    "points of negative energy damage per caster level (maximum 14d3). On a successful saving throw, " +
