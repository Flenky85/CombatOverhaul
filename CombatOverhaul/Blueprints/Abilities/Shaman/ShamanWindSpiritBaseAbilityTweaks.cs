...
{
    [AutoRegister]
    internal static class ShamanWindSpiritBaseAbilityTweaks
    {
        public static void Register()
        {
            AbilityConfigurator.For(AbilitiesGuids.ShamanWindSpiritBaseAbility)
                ...
                .SetDescriptionValue(
                    "As a standard action, the shaman can make a melee touch attack that deals 1d8 points of electricity " +
                    "damage for every 2 shaman levels she possesses. At 11th level, any weapon she wields is treated as " +
                    "a shocking weapon..\n" +
