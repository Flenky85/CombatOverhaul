...
{
    [AutoRegister]
    internal static class ShamanHexAmelioratingDazzleAbilityTweaks
    {
        public static void Register()
        {
            AbilityConfigurator.For(AbilitiesGuids.ShamanHexAmelioratingDazzleAbility)
                ...
                .SetDescriptionValue(
                    ...
                    "for two rounds plus one aditional per 5th shaman's level. Additionally, the shaman grants her target a +4 " +
