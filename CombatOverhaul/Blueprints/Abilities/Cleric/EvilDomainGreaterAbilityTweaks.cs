...
{
    [AutoRegister]
    internal static class EvilDomainGreaterAbilityTweaks
    {
        public static void Register()
        {
            AbilityConfigurator.For(AbilitiesGuids.EvilDomainGreaterAbility)
                ...
                .SetDescriptionValue(
                    "At 8th level, you can give a weapon you touch the evil special weapon quality for a number of rounds 6 " +
                    "rounds." +
