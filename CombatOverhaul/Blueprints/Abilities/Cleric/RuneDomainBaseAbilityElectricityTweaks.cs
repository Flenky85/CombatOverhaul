...
{
    [AutoRegister]
    internal static class RuneDomainBaseAbilityElectricityTweaks
    {
        public static void Register()
        {
            AbilityConfigurator.For(AbilitiesGuids.RuneDomainBaseAbilityElectricity)
                ...
                .SetDescriptionValue(
                    ...
                    "5-foot area around the rune takes 1d6 electricity damage plus 1 point for every two levels you possess in " +
