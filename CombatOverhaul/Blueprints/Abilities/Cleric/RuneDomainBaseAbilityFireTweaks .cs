...
{
    [AutoRegister]
    internal static class RuneDomainBaseAbilityFireTweaks
    {
        public static void Register()
        {
            AbilityConfigurator.For(AbilitiesGuids.RuneDomainBaseAbilityFire)
                ...
                .SetDescriptionValue(
                    ...
                    "5-foot area around the rune takes 1d6 fire damage plus 1 point for every two levels you possess in " +
