...
{
    [AutoRegister]
    internal static class GoodDomainGreaterAbilityTweaks
    {
        public static void Register()
        {
            AbilityConfigurator.For(AbilitiesGuids.GoodDomainGreaterAbility)
                ...
                .SetDescriptionValue(
                    "At 8th level, you can give a weapon you touch the holy special weapon quality for a number of rounds 6 " +
                    "rounds." +
