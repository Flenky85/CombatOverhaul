...
{
    [AutoRegister]
    internal static class RuneDomainBaseAbilityColdTweaks
    {
        public static void Register()
        {
            AbilityConfigurator.For(AbilitiesGuids.RuneDomainBaseAbilityCold)
                ...
                .SetDescriptionValue(
                    ...
                    "5-foot area around the rune takes 1d6 cold damage plus 1 point for every two levels you possess in " +
