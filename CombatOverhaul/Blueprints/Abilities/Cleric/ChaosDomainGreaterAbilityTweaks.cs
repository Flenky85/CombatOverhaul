...
{
    [AutoRegister]
    internal static class ChaosDomainGreaterAbilityTweaks
    {
        public static void Register()
        {
            AbilityConfigurator.For(AbilitiesGuids.ChaosDomainGreaterAbility)
                ...
                .SetDescriptionValue(
                    "At 8th level, you can give a weapon you touch the anarchic special weapon quality for 6 rounds." +
