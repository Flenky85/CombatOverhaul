...
{
    [AutoRegister]
    internal static class WitchHexAmelioratingDazzleAbilityTweaks
    {
        public static void Register()
        {
            AbilityConfigurator.For(AbilitiesGuids.WitchHexAmelioratingDazzleAbility)
                ...
                .SetDescriptionValue(
                    ...
                    "for two rounds plus one aditional per 5th witch's level. Additionally, the witch grants her target a +4 " +
