...
namespace CombatOverhaul.Resources
{
    internal static class AbilityResourceRegenOnNewRound
    {
        ...
        private static readonly List<RegenRule> _rules = new List<RegenRule>
        {
            ...
            new RegenRule(AbilitiesResourcesGuids.GloryDomainGreaterResource, flat: 1, percentOfMax: 0f),
            new RegenRule(AbilitiesResourcesGuids.GoodDomainGreaterResource, flat: 1, percentOfMax: 0f),
            new RegenRule(AbilitiesResourcesGuids.ChaosDomainGreaterResource, flat: 1, percentOfMax: 0f),
            new RegenRule(AbilitiesResourcesGuids.CharmDomainGreaterResource, flat: 1, percentOfMax: 0f),
            new RegenRule(AbilitiesResourcesGuids.DarknessDomainGreaterResource, flat: 1, percentOfMax: 0f),
            new RegenRule(AbilitiesResourcesGuids.DarknessDomainGreaterResource, flat: 1, percentOfMax: 0f),
            new RegenRule(AbilitiesResourcesGuids.EvilDomainGreaterResource, flat: 1, percentOfMax: 0f),
            new RegenRule(AbilitiesResourcesGuids.KnowledgeDomainGreaterResource, flat: 1, percentOfMax: 0f),
            new RegenRule(AbilitiesResourcesGuids.LawDomainGreaterResource, flat: 1, percentOfMax: 0f),
            new RegenRule(AbilitiesResourcesGuids.LuckDomainGreaterResource, flat: 1, percentOfMax: 0f),
            new RegenRule(AbilitiesResourcesGuids.MadnessDomainGreaterResource, flat: 1, percentOfMax: 0f),
            new RegenRule(AbilitiesResourcesGuids.MagicDomainGreaterResource, flat: 1, percentOfMax: 0f),
            new RegenRule(AbilitiesResourcesGuids.NobilityDomainGreaterResource, flat: 1, percentOfMax: 0f),
            new RegenRule(AbilitiesResourcesGuids.RuneDomainGreaterResource, flat: 1, percentOfMax: 0f),
            new RegenRule(AbilitiesResourcesGuids.TravelDomainGreaterResource, flat: 1, percentOfMax: 0f),
            new RegenRule(AbilitiesResourcesGuids.WeatherDomainGreaterResource, flat: 1, percentOfMax: 0f),
            new RegenRule(AbilitiesResourcesGuids.TrickeryDomainGreaterResource, flat: 1, percentOfMax: 0f,
                BuffsGuids.TrickeryDomainGreaterBuff),
            new RegenRule(AbilitiesResourcesGuids.SunDomainGreaterResource, flat: 1, percentOfMax: 0f,
                BuffsGuids.SunDomainGreaterBuff),
            new RegenRule(AbilitiesResourcesGuids.ProtectionDomainGreaterResource, flat: 1, percentOfMax: 0f,
                BuffsGuids.ProtectionDomainGreaterBuff),
            new RegenRule(AbilitiesResourcesGuids.ReposeDomainGreaterResource, flat: 1, percentOfMax: 0f,
                BuffsGuids.ReposeDomainGreaterBuff),
            new RegenRule(AbilitiesResourcesGuids.LiberationDomainGreaterResource, flat: 1, percentOfMax: 0f,
                BuffsGuids.LiberationDomainGreaterBuff),
            new RegenRule(AbilitiesResourcesGuids.PlantDomainGreaterResource, flat: 1, percentOfMax: 0f,
                BuffsGuids.PlantDomainGreaterBuff),
            new RegenRule(AbilitiesResourcesGuids.ArtificeDomainBaseResource, flat: 1, percentOfMax: 0f,
                BuffsGuids.ArtificeDomainBaseBuff),
            new RegenRule(AbilitiesResourcesGuids.DestructionDomainGreaterResource, flat: 1, percentOfMax: 0f,
                BuffsGuids.DestructionDomainGreaterBuff),
