...
namespace CombatOverhaul.Utils
{
    internal static class BlueprintCoreDescriptionExtensions
    {
        ...
        // --- Warning! Key ---
        private const string Key_Duration_12Rounds = "CO.Duration.12Rounds";
        ...
        public static AbilityConfigurator SetDuration12RoundsShared(this AbilityConfigurator cfg)
        {
            return cfg.OnConfigure(bp =>
            {
                bp.LocalizedDuration = LsFromKey(Key_Duration_12Rounds, "12 rounds");
            });
        }
        ...
        public static AbilityConfigurator SetDuration3d3RoundsShared(this AbilityConfigurator cfg)
        {
            return cfg.OnConfigure(bp =>
            {
                bp.LocalizedDuration = LsFromKey(Key_Duration_3d3Rounds, "3d3 rounds");
            });
        }
